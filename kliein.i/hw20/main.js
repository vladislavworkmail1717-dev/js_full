...
console.log(userObj2.fullName()) // John Smith
...
console.log(ageClassification(1));    // Дитинство
console.log(ageClassification(24));   // Дитинство
console.log(ageClassification(24.01)); // Молодість
console.log(ageClassification(44));   // Молодість
console.log(ageClassification(65));   // Зрілість
console.log(ageClassification(75));   // Старість
console.log(ageClassification(90));   // Довголіття
console.log(ageClassification(122));  // Рекорд
...
// Callback для випадкових чисел у діапазоні [a, b]


// Callback для піднесення a до степеня b


// Callback для додавання a та b
...
const cbRandom = (min, max) => Math.floor(Math.random() * (max - min + 1)) + min;
const cbPow = (num, pow) => Math.pow(num, pow);
const cbAdd = (a, b) => a + b;

console.log(mainFunc(2, 5, cbRandom));   // Випадкове ціле від 2 до 5
console.log(mainFunc(10, 30, cbRandom)); // Випадкове ціле від 10 до 30
console.log(mainFunc(2, 5, cbPow));      // 32
console.log(mainFunc(2, 5, cbAdd));      // 7
console.log(mainFunc(2, 5, 'not a func')); // false
