 ...
 * Завдання: Розробити модуль на JavaScript, який імплементує клас CalorieCalculator. Клас має використовувати Map для управління
 * даними про калорійність продуктів. Необхідно реалізувати наступні функціональності:
 * Додавання продуктів: Метод addProduct приймає назву продукту та його калорійність, додаючи їх до колекції.
 * Отримання калорійності продукту: Метод getProductCalories повертає калорійність продукту за його назвою. Якщо продукт не знайдено,
 ...
 */
console.log("Task 1: Calorie Calculator");
class CalorieCalculator {
  constructor() {
    this.productsWithCalories = new Map();
  }

  addProduct(productName, calories) {
    this.productsWithCalories.set(productName, calories);
  }

  getProductCalories(productName) {
    let calories = this.productsWithCalories.get(productName);
  ...
  removeProduct(productName) {
    this.productsWithCalories.delete(productName);
  }
}
 ...
 * Завдання: Реалізувати модуль на JavaScript у формі класу UniqueUsernames, який використовує Set для збереження унікальних
 * імен користувачів. Клас має надавати можливість:
 ...
 */
console.log("Task 2: Unique Usernames");
